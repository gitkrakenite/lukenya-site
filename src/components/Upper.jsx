      ...
      <div className="flex gap-[20px]">
        ...
        <div className="flex-[0.4] relative">
          ...
          <img
            ...
            alt=""
            className="w-[120px] object-contain rounded-lg absolute top-0 z-[1] right-[10px] "
          />

          <img
            src="https://images.pexels.com/photos/14456845/pexels-photo-14456845.jpeg?auto=compress&cs=tinysrgb&w=600"
            alt=""
            className="w-[120px] object-contain rounded-lg absolute top-[80px] z-[1] right-[-30px] "
          />

          <img
            src="https://images.pexels.com/photos/962317/pexels-photo-962317.jpeg?auto=compress&cs=tinysrgb&w=600"
            alt=""
            className="w-[280px] object-contain rounded-lg absolute top-[140px]  right-[-80px] "
          />
        </div>
      </div>
    </div>
